...
<body>
	...
	<div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel" style="margin-top: 30px">
		...
		<button class="carousel-control-next" type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="next">
			<span class="carousel-control-next-icon" aria-hiddsen="true"></span> <span class="visually-hidden">Next</span>
		</button>
	</div>
	<br>
	<!-- 중간 나눔 줄 -->
		...
		<div class="row">
			<div class="col-3">
				<div class="card" style="width: 18rem; margin-top: 50px">
					<img id="content_img" src="/resources/img/project_img.png" class="card-img-top" alt="...">
					<div class="card-body">
						<p class="card-text">
							언어 : Java, JavaScript<br>경력 : 신입<br>직무 : Frontend
						</p>
					</div>
				</div>
			</div>
			<div class="col-3">
				<div class="card" style="width: 18rem; margin-top: 50px">
					...
					<div class="card-body">
						<p class="card-text">
							언어 : Java, JavaScript<br>경력 : 2년<br>직무 : Backend
						</p>
					</div>
				</div>
			</div>
			<div class="col-3">
				<div class="card" style="width: 18rem; margin-top: 50px">
					<img id="content_img" src="/resources/img/project_img.png" class="card-resources/img-top" alt="...">
					<div class="card-body">
						<p class="card-text">
							언어 : Java, JavaScript<br>경력 : 신입<br>직무 : Backend
						</p>
					</div>
				</div>
			</div>
			<div class="col-3">
				<div class="card" style="width: 18rem; margin-top: 50px">
					<img id="content_img" src="/resources/img/project_img2.png" class="card-resources/img-top" alt="...">
					<div class="card-body">
						<p class="card-text">
							언어 : Java, JavaScript<br>경력 : 5년<br>직무 : Backend
						</p>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-3">
				<div class="card" style="width: 18rem; margin-top: 50px">
					...
					<div class="card-body">
						<p class="card-text">
							언어 : Java, JavaScript<br>경력 : 1년<br>직무 : Frontend
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-3">
				<div class="card" style="width: 18rem; margin-top: 50px">
					...
					<div class="card-body">
						<p class="card-text">
							언어 : Java, JavaScript<br>경력 : 10년<br>직무 : Backend
						</p>
					</div>
				</div>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-3">
				<div class="card" style="width: 18rem; margin-top: 50px">
					<img id="content_img" src="/resources/img/project_img3.png" class="card-resources/img-top" alt="...">
					<div class="card-body">
						<p class="card-text">
							언어 : Java, JavaScript<br>경력 : 신입<br>직무 : Backend
						</p>
			...
			<div class="col-3">
				<div class="card" style="width: 18rem; margin-top: 50px">
					...
					<div class="card-body">
						<p class="card-text">
							언어 : Java, JavaScript<br>경력 : 7년<br>직무 : Backend
						</p>
					</div>
				</div>
			</div>
